...
export const resourceDefinitions: ResourceDefinition[] = [
  { id: "power", label: "Power", short: "MW", color: "#f3b34c" },
  ...
  { id: "coal", label: "Coal", short: "t", color: "#878583" },
  { id: "oil", label: "Oil", short: "bbl", color: "#a76b4d" },
  { id: "glass", label: "Glass", short: "u", color: "#8ed7d8" },
  { id: "fertilizer", label: "Fertilizer", short: "kg", color: "#9cc56c" },
