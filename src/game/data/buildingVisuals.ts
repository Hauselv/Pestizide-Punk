...
export const buildingVisualMap: Record<string, BuildingVisualDefinition> = {
  ...
  "biogas-digester": { icon: "/buildings/icons/bio-reactor.png", label: "Biogas", tint: "rgba(121, 177, 101, 0.22)" },
  ...
  "steam-accumulator": { icon: "/buildings/icons/battery-storage.png", label: "Steam", tint: "rgba(186, 153, 115, 0.22)" },
  ...
  "glassworks": { icon: "/buildings/icons/industrial-works.png", label: "Glass", tint: "rgba(123, 198, 206, 0.2)" },
  "compost-yard": { icon: "/buildings/icons/bio-reactor.png", label: "Compost", tint: "rgba(121, 177, 101, 0.2)" },
  ...
  "beneficial-fungi-lab": { icon: "/buildings/icons/field-lab.png", label: "Bio Lab", tint: "rgba(118, 165, 112, 0.22)" },
  ...
  "pollinator-dome": { icon: "/buildings/icons/external-fields.png", label: "Pollinator", tint: "rgba(140, 196, 116, 0.2)" },
  "aquaponics-hall": { icon: "/buildings/icons/aquaponics.png", label: "Aquaponics", tint: "rgba(89, 169, 174, 0.22)" },
  "fish-tanks": { icon: "/buildings/icons/aquaponics.png", label: "Fish", tint: "rgba(82, 158, 188, 0.22)" },
  "algae-bioreactor": { icon: "/buildings/icons/aquaponics.png", label: "Algae", tint: "rgba(86, 185, 154, 0.22)" },
  "mushroom-vault": { icon: "/buildings/icons/fungal-vault.png", label: "Fungi", tint: "rgba(124, 146, 102, 0.22)" },
  "mycoprotein-vats": { icon: "/buildings/icons/fungal-vault.png", label: "Myco", tint: "rgba(124, 146, 102, 0.22)" },
  ...
  "pheromone-hub": { icon: "/buildings/icons/defense-tower.png", label: "Pheromone", tint: "rgba(126, 183, 114, 0.22)" },
  "soil-sterilizer-rig": { icon: "/buildings/icons/defense-tower.png", label: "Sterilizer", tint: "rgba(198, 114, 86, 0.24)" },
  ...
  "vehicle-seal-bay": { icon: "/buildings/icons/logistics-hub.png", label: "Vehicle Seal", tint: "rgba(132, 164, 175, 0.2)" }
};
